...
[caption id="attachment_421" align="none" width="181" caption="Keeping the backbone views and models in separate files and folders is a good way of helping you navigate your app. For larger scale projects, this is essential."]<a href="http://www.oneofthesedaysblog.com/wp-content/uploads/2011/02/Screen-shot-2011-02-12-at-4.20.35-PM.png"><img src="http://www.oneofthesedaysblog.com/wp-content/uploads/2011/02/Screen-shot-2011-02-12-at-4.20.35-PM.png" alt="App directory structure" title="App directory structure" width="181" height="386" class="size-full wp-image-421" /></a>[/caption]
...
<head>
	...
	<style>
	    #cannon {border:none;position:absolute;top:175px}
	    #firingRange {position:absolute;left:250px}
	    .loading {position:absolute;left:1px;top:242px;}
	</style>
	...
	<script src='scripts/backbone/models/cannon.js'></script>
	<script src='scripts/backbone/views/cannon.js'></script>
	<script src='scripts/backbone/views/loading.js'></script>
	<script src='scripts/backbone/views/ball.js'></script>
	<script src='scripts/main.js'></script>	
</head>

<body>    
    <a href='#' class='do'>
        <img src='images/cannon.png' id="cannon"/>
    </a>
    <canvas id="firingRange" width="300" height="200">
</canvas></body>
</html>
</pre>
...
<pre class='brush:javascript'>
    Backbone.sync = function(method, model, success, error) {            
       ...
       /* snip */
        ...
        Backbone.beforeSync(); // run our before callback
        $.ajax(params);
      };
</pre>
...
window.Cannon = Backbone.Model.extend({
   ...
   url : 'http://oneofthesedaysblog.com/server/backbone-canvas/sleep.php', // our delay script

   defaults : {
       ammo : 100 // a new cannon has 100 cannon balls 
   },
