[caption id="attachment_372" align="alignright" width="87" caption="Web development that doesn\'t hurt"]<a href="http://www.oneofthesedaysblog.com/wp-content/uploads/2010/07/Rails.png"><img src="http://www.oneofthesedaysblog.com/wp-content/uploads/2010/07/Rails.png" alt="Ruby on Rails" title="Rails" width="87" height="111" class="size-full wp-image-372" /></a>[/caption]Let's be honest, Ruby on Rails is probably why you're learning Ruby. It couldn't be an easier framework to switch to, not because of the framework necessarily, but because of all the support and information available on it. Rather than start another Rails tutorial series, I will be compiling lists of the tutorials and guides that have helped me, for each part of Rails. <em>To give this some context, I am working on a Facebook application in rails and so this will flavour the resources I use.</em>
